...
- [Quantitative Foundations](/read/quant-foundations) -- the mathematical prerequisites (probability distributions, linear algebra, stochastic processes) that underpin the econometric methods here
- [GARCH 101](/read/garch-101) -- deep dive into the univariate volatility models that form the building blocks of DCC-GARCH
- [Hayek: Prices and Production](/read/hayek-prices-and-production) -- the Austrian credit cycle theory referenced in the macro frameworks section
- [Keynes: The General Theory](/read/keynes-general-theory) -- the demand-side macro framework and its implications for fiscal policy and asset pricing
- [Factor Models (Gappy Lecture 2)](/read/gappy-lecture-2-factor-models) -- how covariance estimation and regime dynamics connect to systematic factor investing
