...
- [Buffett's Shareholder Letters](/read/buffett-shareholder-letters) -- Buffett's five decades of letters show Graham's principles in action, extended and refined through real-world capital allocation
- [Fisher's Common Stocks and Uncommon Profits](/read/fisher-common-stocks) -- the growth investing framework that Charlie Munger used to push Buffett beyond Graham's pure net-net approach
- [Damodaran's Little Book of Valuation](/read/damodaran-little-book-valuation) -- a modern, rigorous treatment of intrinsic value estimation that builds on Graham's foundational concepts
- [Howard Marks' Oaktree Memos](/read/marks-oaktree-memos) -- Marks' treatment of risk, cycles, and margin of safety as a credit investor provides a complementary perspective to Graham's equity-focused framework
