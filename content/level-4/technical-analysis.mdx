...
- [Behavioral Finance](/read/behavioral-finance) -- the psychological foundations that explain why chart patterns reflect persistent human biases rather than random noise
- [Market Microstructure and Trading](/read/market-microstructure-trading) -- how order flow, market makers, and execution mechanics create the price action that technicians analyze
- [Livermore's Reminiscences of a Stock Operator](/read/livermore-reminiscences) -- the original practitioner's account of reading the tape, understanding market psychology, and managing risk through price action
- [Schwager's Market Wizards](/read/schwager-market-wizards) -- interviews with the greatest traders of the 20th century, many of whom built their fortunes on technical analysis and systematic trading
